...
//Joystick view created by zerokol

/**
 * Open-source joystick view class created by zerokol
...
public class JoystickView extends View implements Runnable {
    ...
    //method added to reset the position of the control knob back to the controller's origin.
    public void reset(){
	...
	protected void initJoystickView() {
		...
		secondaryCircle.setColor(Color.WHITE);
	...
	protected void onSizeChanged(int xNew, int yNew, int xOld, int yOld) {
		...
		buttonRadius = (int) (d / 2 * 0.25); //0.25 is the radius of the control stick
