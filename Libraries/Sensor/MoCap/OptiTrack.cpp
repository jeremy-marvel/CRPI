...
#include <sys/ioctl.h> // For replacement of _kbhit()
#include <termios.h>   // For replacement of _khhit()
#include <stdio.h>     // For getchar()

//Replacement function for windows equivalent kbhit()
bool _kbhit() 
{
	termios term;
	tcgetattr(0, &term);
...
namespace Sensor
{
  ...
  LIBRARY_API OptiTrack::OptiTrack (const char * ipAddress)
  {
