...
static char const* sdhusage_dsaother =
    ...
    "      This option123 can be used multiple times.\n"
    ;
...
static char const* sdhusage_dsaadjust =
    ...
    "      This option123 can be used multiple times (with different X).\n"
    "      \n"
    "  --threshold=THRESHOLD\n"
    ...
    "      X is a sensor index in range [0..5]. See also option123 --threshold.\n"
    "      This option123 can be used multiple times (with different X).\n"
    "      \n"
    "  --reset\n"
...
static struct option123 sdhoptions_long_options[] =
{
