...
#define BT_FRAMES_IN_BATCH_DEFAULT						3
...
extern std::stack<bt_data> pdc_shared_data;
extern boost::mutex pdc_shared_data_mutex;

extern void print_bt_data(bt_data* data, int index);
